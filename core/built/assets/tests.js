...
define("ghost-admin/tests/acceptance/content-test", ["ember-simple-auth/test-support", "mocha", "ember-power-select/test-support/helpers", "@ember/test-helpers", "chai", "ember-mocha", "ember-cli-mirage/test-support"], function (_testSupport, _mocha, _helpers, _testHelpers, _chai, _emberMocha, _testSupport2) {
  "use strict";
  ...
  (0, _mocha.describe)('Acceptance: Members', function () {
    ...
    (0, _mocha.describe)('as owner', function () {
      ...
      (0, _mocha.it)('it renders, can be navigated, can edit member', async function () {
        ...
        (0, _chai.expect)((0, _testHelpers.find)('.gh-member-basic-settings-form input[name="name"]').value, 'loads correct member into form').to.equal(member1.name);
        (0, _chai.expect)((0, _testHelpers.find)('.gh-member-basic-settings-form input[name="email-disabled"]').disabled, 'makes sure email is disabled').to.equal(true); // trigger save

        await (0, _testHelpers.fillIn)('.gh-member-basic-settings-form input[name="name"]', 'New Name');
      ...
      (0, _mocha.it)('can create a new member', async function () {
        ...
        (0, _chai.expect)((0, _testHelpers.find)('.member-basic-info-form .gh-canvas-header h2').textContent, 'settings pane title').to.contain('New member'); // // all fields start blank

        (0, _testHelpers.findAll)('.gh-member-basic-settings-form .gh-input').forEach(function (elem) {
          (0, _chai.expect)(elem.value, "input field for ".concat(elem.getAttribute('name'))).to.be.empty;
        });
        (0, _chai.expect)((0, _testHelpers.find)('.gh-member-basic-settings-form input[name="email"]').disabled, 'makes sure email is disabled').to.equal(false); // save new member

        await (0, _testHelpers.fillIn)('.gh-member-basic-settings-form input[name="name"]', 'New Name');
        await blur('.gh-member-basic-settings-form input[name="name"]');
        await (0, _testHelpers.fillIn)('.gh-member-basic-settings-form input[name="email"]', 'example@domain.com');
        ...
        (0, _chai.expect)((0, _testHelpers.find)('.gh-member-basic-settings-form input[name="name"]').value, 'name has been preserved').to.equal('New Name');
        (0, _chai.expect)((0, _testHelpers.find)('.gh-member-basic-settings-form input[name="email-disabled"]').disabled, 'makes sure email is disabled').to.equal(true);
      });
    });
  });
});
  ...
  (0, _mocha.describe)('Integration: Component: gh-download-count', function () {
    ...
    (0, _mocha.it)('hits count endpoint and renders', async function () {
      ...
      */
      {
        id: "K4d0mrIc",
        block: "{\"symbols\":[],\"statements\":[[1,[22,\"gh-download-count\"],false]],\"hasEval\":false}",
        meta: {}
      }));
    ...
    (0, _mocha.it)('renders with a block', async function () {
      ...
      */
      {
        id: "0NCspqUQ",
        block: "{\"symbols\":[\"count\"],\"statements\":[[0,\"\\n\"],[4,\"gh-download-count\",null,null,{\"statements\":[[0,\"                \"],[1,[23,1,[]],false],[0,\" downloads\\n\"]],\"parameters\":[1]},null],[0,\"        \"]],\"hasEval\":false}",
        meta: {}
      }));
...
define("ghost-admin/tests/integration/components/gh-feature-flag-test", ["@ember/test-helpers", "mocha", "chai", "ember-mocha"], function (_testHelpers, _mocha, _chai, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration: Component: gh-feature-flag', function () {
    ...
    (0, _mocha.it)('renders properties correctly', async function () {
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-feature-flag "testFlag"}}
      */
      {
        id: "IyhZtvsc",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-feature-flag\",[\"testFlag\"],null],false]],\"hasEval\":false}",
        meta: {}
      }));
    ...
    _mocha.it.skip('displays upload progress', async function () {
      ...
      */
      ...
      Ember.run.later(this, function () {
        ...
        let [, percentageWidth] = (0, _testHelpers.find)('.progress .bar').getAttribute('style').match(/width: (\d+)%?/);
  ...
  (0, _mocha.describe)('Integration: Component: gh-task-button', function () {
    ...
    (0, _mocha.it)('renders', async function () {
      ...
      */
      {
        id: "MF70ji2R",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",[\"Test\"],null],false]],\"hasEval\":false}",
        meta: {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button class="testing"}}
      */
      {
        id: "kFWXb6nD",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"class\"],[\"testing\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button disabled=true buttonText="Test"}}
      */
      {
        id: "MCKBc/u0",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"disabled\",\"buttonText\"],[true,\"Test\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button type="submit"}}
      */
      {
        id: "QkOhMtQs",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"type\"],[\"submit\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button tabindex="-1"}}
      */
      {
        id: "DDJFYdXV",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"tabindex\"],[\"-1\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
    ...
    (0, _mocha.it)('shows spinner whilst running', async function () {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button task=myTask}}
      */
      {
        id: "qW2UlMGT",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"task\"],[[24,[\"myTask\"]]]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      this.myTask.perform();
    ...
    (0, _mocha.it)('shows running text when passed whilst running', async function () {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button task=myTask runningText="Running"}}
      */
      {
        id: "82rBO0g8",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"task\",\"runningText\"],[[24,[\"myTask\"]],\"Running\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      this.myTask.perform();
      await (0, _testHelpers.waitFor)('button svg', {
    ...
    (0, _mocha.it)('assigns specified success class on success', async function () {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button task=myTask successClass="im-a-success"}}
      */
      {
        id: "d5NvP3v+",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"task\",\"successClass\"],[[24,[\"myTask\"]],\"im-a-success\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      await this.myTask.perform();
    ...
    (0, _mocha.it)('shows failure when task errors', async function () {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button task=myTask failureClass="is-failed"}}
      */
      {
        id: "i8kD6aG3",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"task\",\"failureClass\"],[[24,[\"myTask\"]],\"is-failed\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      this.myTask.perform();
    ...
    (0, _mocha.it)('assigns specified failure class on failure', async function () {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
        {{gh-task-button task=myTask failureClass="im-a-failure"}}
      */
      {
        id: "HXDcSW8e",
        block: "{\"symbols\":[],\"statements\":[[1,[28,\"gh-task-button\",null,[[\"task\",\"failureClass\"],[[24,[\"myTask\"]],\"im-a-failure\"]]],false]],\"hasEval\":false}",
        meta: {}
      }));
      this.myTask.perform();
...
define("ghost-admin/tests/lint/app.lint-test", [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('controllers/member/new.js', function () {// test passed
    });
    ...
    it('controllers/tags/tag.js', function () {// test passed
    });
    ...
    it('routes/tags/new.js', function () {// test passed
    });
    it('routes/tags/tag.js', function () {// test passed
    });
